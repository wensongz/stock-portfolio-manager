...
export default function CategoryTab({ selectedCategoryId, onCategoryChange, baseCurrency }: Props) {
  ...
  const stockColumns: ColumnsType<AggregatedStock> = useMemo(() => [
    ...
    { title: "现价", dataIndex: "current_price", key: "current_price", align: "right", width: 100, sorter: (a, b) => a.current_price - b.current_price, render: (v: number, r) => formatMoney(v, r.currency) },
